...
syntax  match  TodoNote       '\(^\|\W\)note:[^[:blank:]]\+'  contains=NONE
syntax  match  TodoNote       '\(^\|\W\)enote:[^[:blank:]]\+'  contains=NONE
...
highlight  default  link  TodoNote       Repeat
highlight  default  link  TodoENote       Repeat
